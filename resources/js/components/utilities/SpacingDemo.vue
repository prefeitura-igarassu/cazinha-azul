<template>
    <div class="grid grid-cols-12 gap-0 spacing-demo">
        <div class="col-12">
            <div class="card">
                <h4>Spacing</h4>
                <p><router-link to="grid grid-cols-12 gap-0">PrimeFlex</router-link> provides various spacing utilities to modify
        ...
        <div class="col-12 md:col-6">
            <div class="card">
                ...
                <h6>Without Spacing</h6>
                <div class="grid grid-cols-12 gap-0 formgrid p-fluid">
